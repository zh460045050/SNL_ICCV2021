...
class _SelfAttentionBlock(nn.Module):
    ...
    def __init__(self, in_channels, key_channels, value_channels, out_channels=None, scale=1, norm_type="batchnorm",psp_size=(1,3,6,8)):
...
class APNB(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, key_channels, value_channels, dropout=0.5, sizes=([1]), norm_type=None,psp_size=(1,3,6,8)):
